...
public class ReagentStockLoss implements Serializable {
    ...
    @ApiModelProperty(value = "库损状态： '0': '丢失' ，'1', '破损'， '2' '过期'， '3','其他原因'")
    ...
    public Date getUseExpire() {
        return useExpire;
    }

    public void setUseExpire(Date useExpire) {
    ...
    public String toString() {
        ...
        sb.append(", useExpire=").append(useExpire);
