  ...
  <div class="app-container">
    ...
    <div class="table-container">
      <el-table ref="BranchOutTable"
        ...
        <!--        <el-table-column label="申请科室名称" align="center">-->
...
export default {
  ...
  data() {
    return {
      ...
      listLoading: false,
      dialogVisible: false,
      BranchOut: Object.assign({}, defaultBranchOut),
      allCentreOutList: [],
      //申请单状态
      statusData: [
        {
  ...
  methods: {
    ...
    getList() {
      ...
      this.listQuery.billType = this.BranchOut.billType;
