  ...
  <div class="app-container">
    <el-card class="filter-container" shadow="never">
      ...
      <div style="margin-left: 10px;margin-top: 10px">
        <span>制表人：{{ listQuery.username }},{{ branch }},{{
            listQuery.startTime|formatDate
          }}——{{ listQuery.endTime|formatDate }}</span>
      </div>
...
<script>
import {countCollect} from '@/api/collect'
...
export default {
  ...
  methods: {
    ...
    getList() {
      ...
      countCollect(this.listQuery).then(response => {
